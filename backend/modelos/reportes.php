...
class Reportes {
    ...
    public function consulta() {
        $sql = "SELECT r.id, r.titulo, r.descripcion, r.fecha, r.usuario_id, u.nombre AS usuario
                FROM reportes r
    ...
    public function insertar($params) {
        if (empty($params->titulo)) return ["Resultado"=>"ERROR", "Mensaje"=>"Título obligatorio"];
    ...
    public function editar($id, $params) {
        ...
        mysqli_stmt_execute($stmt);
        return ["Resultado"=>"OK", "Mensaje"=>"Reporte actualizado"];
    }
    ...
    public function eliminar($id) {
        ...
        mysqli_stmt_execute($stmt);
        return ["Resultado"=>"OK", "Mensaje"=>"Reporte eliminado"];
    }
